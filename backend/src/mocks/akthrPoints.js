...
export const MOCK_AKTHR_STARTING_BALANCE = 120;

// Points granted when a member follows a predicted-offer plan (campaign-funded).
export const MOCK_AKTHR_OFFER_REWARD = 25;
