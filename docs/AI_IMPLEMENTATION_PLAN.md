...
`visual-design/` is an offline RTL component laboratory; `ml-results-showcase/` is a separate offline results dashboard. Both consume generated artifacts. A sync script generates `generated-results.js`; Playwright captures independent 1920×1080 and 1600×900 PNGs. Neither folder is linked from the production frontend.
